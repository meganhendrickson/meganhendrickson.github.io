...
function buildProductList(data) {
    ...
    let dataTable = '<thead>';
    dataTable += '<tr><th>Product Name</th><td class="modify">&nbsp;</td><td class="delete">&nbsp;</td></tr>';
    dataTable += '</thead>';
    ...
    data.forEach(function (element) {
        ...
        dataTable += `<td class="modify"><a href='/acme/products?action=mod&id=${element.invId}' title='Click to modify'>Modify</a></td>`;
        dataTable += `<td class="delete"><a href='/acme/products?action=del&id=${element.invId}' title='Click to delete'>Delete</a></td></tr>`;
    })
    dataTable += '</tbody>';
